$(document).ready(function() {
    ...
    var bannerList=media._getBannerList();
	$(bannerList).each(function(k, v) {
		htm += "<li name='is_tj_r' videoId='"+ v.id+"' style='padding-right: 0;'>";
		htm += '<img src="'+ v.banner.bannerImg+'" />';
		htm += '</li>';
	...
	$("#in ul").css("width", (bannerList.length * 100) + "%");
	$("#in ul li").css("width", (100 / bannerList.length) + "%");
	$(bannerList).each(function(k1, v1) {
		if (k1 != 0)
