...
function sendPvuv(rid,rtype){
    var uri="http://"+platFormIp+"/api/banner/pvuv?mac="+encodeURIComponent(mac)+"&"+"rid="+encodeURIComponent(rid)+"&rtype="+encodeURIComponent(rtype)+"&oid="+encodeURIComponent(myOid);
